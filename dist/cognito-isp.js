...
var _default = {
  mockAddCustomAttributes: mockAddCustomAttributes,
  mockAdminAddUserToGroup: mockAdminAddUserToGroup,
  mockAdminConfirmSignUp: mockAdminConfirmSignUp,
  mockAdminCreateUser: mockAdminCreateUser,
  mockAdminDeleteUser: mockAdminDeleteUser,
  mockAdminDeleteUserAttributes: mockAdminDeleteUserAttributes,
  mockAdminDisableProviderForUser: mockAdminDisableProviderForUser,
  mockAdminDisableUser: mockAdminDisableUser,
  mockAdminEnableUser: mockAdminEnableUser,
  mockAdminForgetDevice: mockAdminForgetDevice,
  mockAdminGetDevice: mockAdminGetDevice,
  mockAdminGetUser: mockAdminGetUser,
  mockAdminInitiateAuth: mockAdminInitiateAuth,
  mockAdminLinkProviderForUser: mockAdminLinkProviderForUser,
  mockAdminListDevices: mockAdminListDevices,
  mockAdminListGroupsForUser: mockAdminListGroupsForUser,
  mockAdminListUserAuthEvents: mockAdminListUserAuthEvents,
  mockAdminRemoveUserFromGroup: mockAdminRemoveUserFromGroup,
  mockAdminResetUserPassword: mockAdminResetUserPassword,
  mockAdminResponseToAuthChallenge: mockAdminResponseToAuthChallenge,
  mockAdminSetUserMFAPreference: mockAdminSetUserMFAPreference,
  mockAdminSetUserSettings: mockAdminSetUserSettings,
  mockAdminUpdateAuthEventFeedback: mockAdminUpdateAuthEventFeedback,
  mockAdminUpdateDeviceStatus: mockAdminUpdateDeviceStatus,
  mockAdminUpdateUserAttributes: mockAdminUpdateUserAttributes,
  mockAdminUserGlobalSignOut: mockAdminUserGlobalSignOut,
  mockAssociateSoftwareToken: mockAssociateSoftwareToken,
  mockChangePassword: mockChangePassword,
  mockConfirmDevice: mockConfirmDevice,
  mockConfirmForgotPassword: mockConfirmForgotPassword,
  mockConfirmSignUp: mockConfirmSignUp,
  mockCreateGroup: mockCreateGroup,
  mockCreateIdentityProvider: mockCreateIdentityProvider,
  mockCreateResourceServer: mockCreateResourceServer,
  mockCreateUserImportGroup: mockCreateUserImportGroup,
  mockCreateUserPool: mockCreateUserPool,
  mockCreateUserPoolClient: mockCreateUserPoolClient,
  mockCreateUserPoolDomain: mockCreateUserPoolDomain,
  mockDeleteGroup: mockDeleteGroup,
  mockDeleteIdentityProvider: mockDeleteIdentityProvider,
  mockDeleteResourceServer: mockDeleteResourceServer,
  mockDeleteUser: mockDeleteUser,
  mockDeleteUserAttributes: mockDeleteUserAttributes,
  mockDeleteUserPool: mockDeleteUserPool,
  mockDeleteUserPoolClient: mockDeleteUserPoolClient,
  mockDeleteUserPoolDomain: mockDeleteUserPoolDomain,
  mockDescribeIdentityProvider: mockDescribeIdentityProvider,
  mockDescribeUserPool: mockDescribeUserPool,
  mockDescribeUserPoolClient: mockDescribeUserPoolClient,
  mockDescribeUserPoolDomain: mockDescribeUserPoolDomain,
  mockForgetDevice: mockForgetDevice,
  mockForgetPassword: mockForgetPassword,
  mockGetCSVHeader: mockGetCSVHeader,
  mockGetDevice: mockGetDevice,
  mockGetGroup: mockGetGroup,
  mockGetIdentityProviderByIdentifier: mockGetIdentityProviderByIdentifier,
  mockGetSigningCertificate: mockGetSigningCertificate,
  mockGetUICustomization: mockGetUICustomization,
  mockGetUser: mockGetUser,
  mockGetUserAttributeVerificationCode: mockGetUserAttributeVerificationCode,
  mockGetUserPoolMfaConfig: mockGetUserPoolMfaConfig,
  mockGlobalSignOut: mockGlobalSignOut,
  mockInitiateAuth: mockInitiateAuth,
  mockListDevices: mockListDevices,
  mockListGroups: mockListGroups,
  mockListIdentityProviders: mockListIdentityProviders,
  mockListResourceServers: mockListResourceServers,
  mockListUserImportJobs: mockListUserImportJobs,
  mockListUserPoolClients: mockListUserPoolClients,
  mockListUserPools: mockListUserPools,
  mockListUsers: mockListUsers,
  mockListUsersInGroup: mockListUsersInGroup,
  mockResendConfirmationCode: mockResendConfirmationCode,
  mockRespondToAuthChallenge: mockRespondToAuthChallenge,
  mockSetRiskConfiguration: mockSetRiskConfiguration,
  mockSetUICustomization: mockSetUICustomization,
  mockSetUserMFAPreference: mockSetUserMFAPreference,
  mockSetUserPoolMfaConfig: mockSetUserPoolMfaConfig,
  mockSetUserSettings: mockSetUserSettings,
  mockSignUp: mockSignUp,
  mockStartUserImportJob: mockStartUserImportJob,
  mockStopUserImportJob: mockStopUserImportJob,
  mockUpdateAuthEventFeedback: mockUpdateAuthEventFeedback,
  mockUpdateDeviceStatus: mockUpdateDeviceStatus,
  mockUpdateGroup: mockUpdateGroup,
  mockUpdateIdentityProvider: mockUpdateIdentityProvider,
  mockUpdateResourceServer: mockUpdateResourceServer,
  mockUpdateUserAttributes: mockUpdateUserAttributes,
  mockUpdateUserPool: mockUpdateUserPool,
  mockUpdateUserPoolClient: mockUpdateUserPoolClient,
  mockVerifySoftwareToken: mockVerifySoftwareToken,
  mockVerifyUserAttribute: mockVerifyUserAttribute,
